...
|7   |pop_from     |Identifier (or URI) of the pop. establishing the interaction.              |related  |TRUE   |FALSE   |                                                                                                                                                                                                                                                                                                                  |
|8   |pop_to       |Identifier (or URI) of the pop. receiving the interaction.                 |related  |TRUE   |FALSE   |                                                                                                                                                                                                                                                                                                                  |
|9   |strength_f   |The strength of the interaction for the item ESTABLISHING the interaction  |float    |TRUE   |FALSE   |                                                                                                                                                                                                                                                                                                                  |
|10  |strength_t   |The strength of the interaction for the item RECEVING the interaction      |float    |TRUE   |FALSE   |                                                                                                                                                                                                                                                                                                                  |
|11  |taxa_from    |Identifier (or URI) of the taxa establishing the interaction.              |related  |FALSE  |FALSE   |                                                                                                                                                                                                                                                                                                                  |
|12  |taxa_to      |Identifier (or URI) of the taxa receiving the interaction.                 |related  |FALSE  |FALSE   |                                                                                                                                                                                                                                                                                                                  |
|13  |units_f      |Units in which the interaction strength is measured                        |string   |TRUE   |FALSE   |                                                                                                                                                                                                                                                                                                                  |
|14  |units_t      |Units in which the interaction strength is measured                        |string   |TRUE   |FALSE   |                                                                                                                                                                                                                                                                                                                  |
